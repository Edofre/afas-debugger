...
export const MUTATE_ADD_SORTING_FIELD = 'get-connectors/MUTATE_ADD_SORTING_FIELD'
export const MUTATE_REMOVE_SORTING_FIELD = 'get-connectors/MUTATE_REMOVE_SORTING_FIELD'
